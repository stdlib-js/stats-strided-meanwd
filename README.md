...
```javascript
meanwd = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-meanwd@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-strided-meanwd/tags). For example,

```javascript
meanwd = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-meanwd@v0.1.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var meanwd = require( 'path/to/vendor/umd/stats-strided-meanwd/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-meanwd@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-strided-meanwd.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-strided-meanwd

[test-image]: https://github.com/stdlib-js/stats-strided-meanwd/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/stats-strided-meanwd/actions/workflows/test.yml?query=branch:v0.1.0

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-strided-meanwd/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-strided-meanwd?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-strided-meanwd.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-strided-meanwd/main
...
[deno-url]: https://github.com/stdlib-js/stats-strided-meanwd/tree/deno
[deno-readme]: https://github.com/stdlib-js/stats-strided-meanwd/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-strided-meanwd/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-strided-meanwd/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-strided-meanwd/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-strided-meanwd/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-strided-meanwd/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-strided-meanwd/main/LICENSE
